...
- Browser caches will rebuild on next use
- ML models will re-download if needed

**Maximum Cleanup** (--maximum):
- Stops and removes all Docker containers/images
- Only deletes node_modules after manual review
- Most impactful but recovers the most space
